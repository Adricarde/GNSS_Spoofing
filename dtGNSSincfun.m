function [dataoutput] = dtGNSSincfun(multiparams)
...
for i=1:n_simulations
    ...
    time_params.dtGNSS=time_params.dtGNSS+0.1;%Frecuencia de acualizacion de medidas GPS, entre dt y 50-60
...
DataFolder=rootfolder+'/dtGNSSinc/';
