function [dataoutput] = nsatelitesincfun(multiparams)
...
%[IMUSIM] = IMU_sim(WORLD,IMU_params,tiempo.dt,'litton200','complete');
...
for i=1:n_simulations
    ...
    dtGNSSvect(i)=SAT.n_satelites;
    SAT.n_satelites=SAT.n_satelites+1;%Numero de satelites totales
