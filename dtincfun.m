function [dataoutput] = dtincfun(multiparams)
...
for i=1:n_simulations
    ...
    %[IMUSIM] = IMU_sim(WORLD,bias_param,tiempo.dt,'litton200','complete');
    trajectories(i,11,size(WORLD.true_tray,1))=0;
    ...
    trajectories(i,:,1:size(WORLD.true_tray,1))=Spoof_Sim.state_vector;
    ...
    dtvect(i)=time_params.dt;
    dtGNSSvect(i)=time_params.dtGNSS;
    endtime(i)=size(WORLD.true_tray,1);
    time_params.dt=time_params.dt+0.001;%Frecuencia de acualizacion de medidas GPS, entre dt y 50-60
